...
export default function Interview() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-start gap-10 py-10 md:py-20">
      <div className="w-full max-w-10/12 md:max-w-4xl flex flex-col items-center gap-10 text-sm md:text-base">
        ...
        <form onSubmit={handleSubmit} className="text-center">
          ...
          <select
            ...
            className="w-full p-3 border border-zinc-50/25 focus:border-zinc-50 focus:outline-none rounded"
          >
